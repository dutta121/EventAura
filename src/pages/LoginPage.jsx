  ...
  return (
    <div className="auth-page animated-gradient">
      <div className="auth-card glass animate-scaleIn">
        ...
        <p className="auth-subtitle">Sign in to continue planning unforgettable events</p>
        ...
        <div className="divider-with-text">or continue with email</div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <button id="login-submit" type="submit" className="btn btn-primary w-full" style={{ marginTop: '1.5rem' }} disabled={loading}>
